...
| V-E | **Discharged for 02, 03 and 04**: `--test conformance` is in step 4, the Python checks are steps 10–11 (both approved 2026-09-21), and `-p sailgym-course` joined step 3 on 2026-09-22 — recorded in `docs/v2/00-foundations.md` F12′, F15.5, F16.9 and F17.6. 05–06 extend the same step-3 list when built. Do not install those gates before their tools exist |
